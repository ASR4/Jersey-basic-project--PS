...
public class ActivitySearchResource {
	...
	public Response searchForActivities(ActivitySearch search){
		...
		System.out.println(search.getDescriptions() + "," + search.getDurationTo() + "," + search.getDurationFrom());
		
		List<Activity> activities = activityRepository.findByContraints(search);
	...
	@GET
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public Response searchForActivites(@QueryParam(value = "description") List<String> descriptions, 
